...
## Ingested 2026-09-12
- [x] Article detail view is bare (headline only). Show source name, byline/date, and images from the feed's enclosure/media fields, not just title text.
- [x] Remove the Journal feed from the default seed list (`FeedStore.seedFeeds`); it's personal, this is a public app. Keep it addable via Suggested.
...
- [x] General UI/color pass, app reads as very basic right now.
