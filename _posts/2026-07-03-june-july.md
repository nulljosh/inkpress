...
**Shipped:** Epiphany v2.6.0 (iOS/macOS), Talli v3.5.1 (iOS/Mac in review), Casewright v1.0.1 (iOS production-ready with picker fix), Inkpress v1.0.1 b3 (iOS resubmitted for review with dark-mode fix), Lexly v1.1.0 (iOS/Mac submitted for review), portfolio iOS app scaffolded (Swift mirror of site content, dark mode live on web).
...
**Active development:** Portfolio (sage.me theme dark mode + perf fixes live, iOS app building); Epiphany (ticker universe: DELL, PENG, DRAM, SNDK, IREN, MU, NBIS, CRDO, MRNA); Talli, Wiretext, Lexly (technical whitepapers added). All test suites passing.
