...
**Shipped:** Epiphany v2.6.0 (iOS/macOS), Talli v3.5.1 (iOS/Mac in review), Casewright v1.0.1 (iOS Waiting for Review), Inkpress v1.0.1 b3 (iOS resubmitted for review with dark-mode fix).

**In flight:** Echo v1.3.3 b8 (iOS Waiting for Review, was rejected 1.3.0). Lexly build 202607060001 live (iOS/Mac screenshots + metadata pending). Healstack v2.3.3 (build valid, awaiting submit). Spark v2.1.0 (Mac live, iOS 4 screenshots remaining). Echo Mac build + upload pending.
