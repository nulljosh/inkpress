...
**In progress:** Books iOS build uploaded with icon (canvas scaling bug present). Portfolio iOS app submission (icon fixed). Echo iOS 1.3.3 (READY_FOR_REVIEW, build 9).
