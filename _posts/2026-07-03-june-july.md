...
Late night: pushed Epiphany 2.5.2 and Talli 3.5.3 to TestFlight and submitted both to the App Store for review. Talli's prior submission (v2.4.2) was cancelled and replaced with the new v3.5.3 release.

## Apps

**Shipped:** Epiphany v2.5.2 (iOS Waiting for Review), Talli v3.5.3 (iOS/Mac Waiting for Review), Casewright v1.0.1 (iOS production-ready with picker fix), Inkpress v1.0.1 b3 (iOS resubmitted for review with dark-mode fix), Lexly v1.1.0 (iOS/Mac submitted for review), portfolio iOS app scaffolded (Swift mirror of site content, dark mode live on web).

**In flight:** Echo v1.3.3 b8 (iOS Waiting for Review). Healstack v2.3.3 (build valid, awaiting submit). Spark v2.1.0 (Mac live, iOS 4 screenshots remaining). Echo Mac build + upload pending.

**Active development:** Portfolio (sage.me theme dark mode + perf fixes live, iOS app building); Epiphany, Talli, Wiretext, Lexly (technical whitepapers added). All test suites passing.
