...
**Shipped:** Epiphany v2.5.2 (iOS Waiting for Review), Talli v2.4.4 (iOS/Mac Waiting for Review), Casewright v1.0.1 (iOS production-ready with picker fix), Inkpress v1.0.1 b3 (iOS resubmitted for review with dark-mode fix), Lexly v1.1.0 (iOS/Mac submitted for review), portfolio iOS app scaffolded (Swift mirror of site content, dark mode live on web).
